...
virtual std::array<float> Vectorizer::vectorize(cv::Mat image, std::array<cv::Rect> faces) {assert(false, "Not implemented");}
virtual std::array<float> Vectorizer::vectorize(cv::Mat image) {assert(false, "Not implemented");}
virtual void Vectorizer::vectorize_update(cv::Mat image, std::array<cv::Rect> faces, std::vector<std::vector<float>> numerical_reps) {assert(false, "Not implemented");}
